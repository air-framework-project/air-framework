...
import cn.airframework.core.support.ReflectiveParameterNameFinder;
...
public class ReflectUtilsTest {
    ...
    public void resolveParameterNames() {
        ParameterNameFinder finder = new ReflectiveParameterNameFinder();
    ...
    public void invokeRaw() {
        ...
        Assert.assertThrows(AirFrameworkException.class, () -> ReflectUtils.invokeRaw(this, method, "arg0"));
        Assert.assertThrows(AirFrameworkException.class, () -> ReflectUtils.invokeRaw(this, method, 12));
        ...
        Assert.assertTrue(ex instanceof AirFrameworkException);
    ...
    public void getFieldValue() {
        ...
        Assert.assertThrows(AirFrameworkException.class, () -> ReflectUtils.getFieldValue(null, ReflectUtils.getDeclaredField(Foo.class, "flag")));
