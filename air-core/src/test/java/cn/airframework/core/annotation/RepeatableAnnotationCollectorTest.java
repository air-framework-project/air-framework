...
public class RepeatableAnnotationCollectorTest {
	...
	public void testCustomCollector() {
		final RepeatableAnnotationCollector collector = RepeatableAnnotationCollector.custom(PREDICATE);
		final Annotation1 annotation = Foo.class.getAnnotation(Annotation1.class);
		final List<Annotation3> annotations = Stream.of(annotation.value())
			.map(Annotation2::value)
			.flatMap(Stream::of)
	...
	@Test
	public void testCustomCollectorWhenAccumulate() {
		final RepeatableAnnotationCollector collector = RepeatableAnnotationCollector.custom(PREDICATE);
	...
	@Test
	public void testAnyCollector() {
		final RepeatableAnnotationCollector collector = RepeatableAnnotationCollector.any();
		Assert.assertSame(collector, RepeatableAnnotationCollector.any());
	...
	@Test
	public void testAnyCollectorWhenAccumulate() {
		final RepeatableAnnotationCollector collector = RepeatableAnnotationCollector.any();
		Assert.assertSame(collector, RepeatableAnnotationCollector.any());
